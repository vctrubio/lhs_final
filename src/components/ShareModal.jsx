...
export default function ShareModal({ isOpen, onClose, title, url }) {
    ...
    const copyPdfToClipboard = async () => {
        try {
            await navigator.clipboard.writeText(pdfMessage);
            alert('¡Enlace del PDF copiado!');
        } catch (err) {
            console.error('Failed to copy:', err);
        }
    };
    ...
    return (
        <div className="fixed inset-0 bg-black bg-opacity-50 z-50 flex items-center justify-center p-4">
            <div ref={modalRef} className="bg-background rounded-lg max-w-md w-full p-6 relative">
                ...
                <div className='flex-col justify-around divide-y'>
                    <div className='my-4'>
