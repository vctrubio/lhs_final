export const IconPrice = ({ width = xny + 10, height = xny + 12, stroke = "#000000" }) => (
    <svg width={width} height={height} viewBox="-4 0 64 64" xmlns="http://www.w3.org/2000/svg" strokeWidth="3" stroke={stroke} fill="none">
